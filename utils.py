...
class Utils:
    ...
    def extrair_apolice(self, valor, seguradora):
        ...
        try:
            ...
            if re.search(r'[a-zA-Z_]', valor_str):
                logger.warning(f"Apólice contém caracteres inválidos: '{valor_str}'.")
                return "endosso"
    ...
    def limpar_nome(self, nome):
        ...
        PALAVRAS_REMOVER = [
            ...
            'PORTO SEGURO', 'SUL AMÉRICA', 'TOKIO MARINE', 'ZURICH SEGUROS',
            ...
            'ACEITOU', 'ACEITA', 'RECUSADA', 'PEND', 'PENDENCIA', 'ALT', 'VLD',
